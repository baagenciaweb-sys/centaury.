    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative bg-gradient-to-r from-slate-800 to-slate-900 text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
          ...
          <Link
            to="/catalog"
            className="inline-flex items-center px-8 py-4 bg-white text-slate-900 font-semibold rounded-lg hover:bg-gray-100 transition-all duration-300 transform hover:scale-105"
          >
            Ver Catálogo
